        ...
        <Container style={{
            color: 'white', textAlign: 'center', padding: '3% 10%'
                ...
                {['Dark'].map((variant) => (
                    ...
                    <p className='par' style={{fontSize:'15px'}}> I am passionate about being in the business of transformation.</p>
                    <p className='par'style={{fontSize:'13px'}}>For the past 20 years, I have been with a team who help clients improve the way they operate and manage their businesses through innovative products and latest technologies. This has helped me develop my business and technical expertise in various areas: business analysis, project management, product designing and development, quality management, marketing and business development.<br/><br/>
